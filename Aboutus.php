...
<body>
    ...
    <div class="main-content">
        <div class="hero-content">
            ...
            <p class="hero-description">Protecting women through innovative technology and immediate response systems</p>
            
            <div class="features-grid">
                <div class="feature-card">
                    <div class="feature-icon">⚠️</div>
                    <h3>SOS Alert System</h3>
                    <p>Instant emergency alerts sent to predetermined contacts with your exact location and situation details.</p>
                </div>
